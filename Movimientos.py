...
def ventas_de_entradas():
    ...
    print(f"¡Compra exitosa! {nombre} tiene su entrada para la función {show}.")
...
def cambio_de_show():
    ...
    print(f"Cambio exitoso: {nombre} ahora está en la función {destino}.")
...
def mostrar_stock_funciones():
    ...
    print("\n--- Stock de Funciones ---")
    print(f" Función 1 (tripulación) disponible: {disponibles1}")
    print(f" Función 2 (sonrisa) disponible:   {disponibles2}")
